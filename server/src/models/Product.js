...
const productSchema = new mongoose.Schema(
  {
    ...
    servingDerived: { type: Boolean, default: false },
    offServingComplete: { type: Boolean, default: false },
    nutrientProfileVersion: { type: Number, default: 1 },
    scoringBasisLabel: { type: String, default: null },
...
productSchema.methods.toProductJSON = function toProductJSON() {
  return {
    ...
    servingDerived: this.servingDerived,
    offServingComplete: this.offServingComplete,
    nutrientProfileVersion: this.nutrientProfileVersion,
    scoringBasisLabel: this.scoringBasisLabel,
